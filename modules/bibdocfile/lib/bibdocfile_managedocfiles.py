          ...
          <tr>
            <td>
              <fieldset>
                ...
                <table>
                  <tr>
                    <td class="label" align="right"><label for="copyrightHolder">Copyright Holder:</label></td>
                    <td align="left"><input id="copyrightHolder" name="copyrightHolder" type="text" size="23" value="" /></td>
                  </tr><tr>
                    <td class="label" align="right"><label for="copyrightDate">Copyright Date:</label></td>
