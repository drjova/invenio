...
def get_authors_autocompletion(
    ...
    author_extra_sources = author_extra_sources or []
    write_file(
        "%s/AUTHOR_EXTRA_SOURCES" % curdir, "\n".join(author_extra_sources))
    ...
    return websubmit_templates.tmpl_authors_autocompletion(
        ...
        author_sources_p = bool(author_sources or author_extra_sources),
...
def get_authors_from_allowed_sources(
    ...
    author_extra_sources = ParamFromFile(os.path.join(CFG_WEBSUBMIT_STORAGEDIR, relative_curdir, "AUTHOR_EXTRA_SOURCES"))
    author_extra_sources = filter(None, author_extra_sources.split("\n"))
    author_sources.extend(author_extra_sources)
    ...
    for author_source in author_sources:
        if author_source in author_extra_sources and result:
            break
